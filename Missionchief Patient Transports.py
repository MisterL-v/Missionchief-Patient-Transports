...
PATH = r""    # Path where you have downloaded the chromedriver.exe - something like this "C:\Users\...\chromedriver.exe"
user_email = ""
user_password = ""
# -------------------------------------------------------------------------------------------
...
if PATH == "" or user_email == "" or user_password == "":
    if PATH == "":
        print("Please update your CHROMEDRIVER-PATH in the skript.")
    else:
        print("Please update your login-email / login-password in the skript.")
else:
    try:
        driver =  webdriver.Chrome(PATH)
    except Exception:
        print("Browser could not be opened. Please make sure your defined Chromedriver-Path is correct.")

    try:
        actions = ActionChains(driver)
    except Exception:
        print("Error while creating an element to scroll. Make sure you have updated all login-credentials and paths in the skript.")
